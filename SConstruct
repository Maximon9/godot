...
from generate_vscode_includes import add_vscode_includes
...
if env.scons_version < (4, 2):
    env["_CPPEXTINCFLAGS"] = (
        "${_concat(EXTINCPREFIX, CPPEXTPATH, EXTINCSUFFIX, __env__, RDirs, TARGET, SOURCE)}"
    )
else:
    env["_CPPEXTINCFLAGS"] = (
...
print(
    f'Building for platform "{env["platform"]}", architecture "{env["arch"]}", target "{env["target"]}".'
)
if env.dev_build:
    print_info(
...
if env["ninja"]:
    if env.scons_version < (4, 2, 0):
        print_error(
            f"The `ninja=yes` option requires SCons 4.2 or later, but your version is {scons_raw_version}."
        )
        Exit(255)
...
add_vscode_includes(
    ...
    exclude=[
        "tests",
        "thirdparty\\accesskit\\include",
        "thirdparty\\amd-fsr",
        "thirdparty\\amd-fsr2",
        "thirdparty\\amd-fsr2\\shaders",
        "thirdparty\\angle\\include\\EGL",
        "thirdparty\\angle\\include\\KHR",
        "thirdparty\\astcenc",
        "thirdparty\\basis_universal\\encoder",
        "thirdparty\\basis_universal\\encoder\\3rdparty",
        "thirdparty\\basis_universal\\transcoder",
        "thirdparty\\brotli\\common",
        "thirdparty\\brotli\\dec",
        "thirdparty\\brotli\\include\\brotli",
        "thirdparty\\clipper2\\include\\clipper2",
        "thirdparty\\cvtt",
        "thirdparty\\d3d12ma",
        "thirdparty\\directx_headers\\include\\directx",
        "thirdparty\\directx_headers\\include\\dxguids",
        "thirdparty\\doctest",
        "thirdparty\\embree\\common\\algorithms",
        "thirdparty\\embree\\common\\lexers",
        "thirdparty\\embree\\common\\math",
        "thirdparty\\embree\\common\\simd",
        "thirdparty\\embree\\common\\simd\\arm",
        "thirdparty\\embree\\common\\simd\\wasm",
        "thirdparty\\embree\\common\\sys",
        "thirdparty\\embree\\common\\tasking",
        "thirdparty\\embree\\include\\embree4",
        "thirdparty\\embree\\kernels",
        "thirdparty\\embree\\kernels\\builders",
        "thirdparty\\embree\\kernels\\bvh",
        "thirdparty\\embree\\kernels\\common",
        "thirdparty\\embree\\kernels\\geometry",
        "thirdparty\\embree\\kernels\\subdiv",
        "thirdparty\\enet\\enet",
        "thirdparty\\etcpak",
        "thirdparty\\freetype\\include",
        "thirdparty\\freetype\\include\\freetype",
        "thirdparty\\freetype\\include\\freetype\\config",
        "thirdparty\\freetype\\include\\freetype\\internal",
        "thirdparty\\freetype\\include\\freetype\\internal\\services",
        "thirdparty\\freetype\\src\\autofit",
        "thirdparty\\freetype\\src\\base",
        "thirdparty\\freetype\\src\\bdf",
        "thirdparty\\freetype\\src\\cache",
        "thirdparty\\freetype\\src\\cff",
        "thirdparty\\freetype\\src\\cid",
        "thirdparty\\freetype\\src\\gxvalid",
        "thirdparty\\freetype\\src\\lzw",
        "thirdparty\\freetype\\src\\otvalid",
        "thirdparty\\freetype\\src\\pcf",
        "thirdparty\\freetype\\src\\pfr",
        "thirdparty\\freetype\\src\\psaux",
        "thirdparty\\freetype\\src\\pshinter",
        "thirdparty\\freetype\\src\\psnames",
        "thirdparty\\freetype\\src\\raster",
        "thirdparty\\freetype\\src\\sdf",
        "thirdparty\\freetype\\src\\sfnt",
        "thirdparty\\freetype\\src\\smooth",
        "thirdparty\\freetype\\src\\svg",
        "thirdparty\\freetype\\src\\truetype",
        "thirdparty\\freetype\\src\\type1",
        "thirdparty\\freetype\\src\\type42",
        "thirdparty\\freetype\\src\\winfonts",
        "thirdparty\\glad\\EGL",
        "thirdparty\\glad\\glad",
        "thirdparty\\glad\\KHR",
        "thirdparty\\glslang\\glslang",
        "thirdparty\\glslang\\glslang\\Include",
        "thirdparty\\glslang\\glslang\\MachineIndependent",
        "thirdparty\\glslang\\glslang\\MachineIndependent\\preprocessor",
        "thirdparty\\glslang\\glslang\\OSDependent",
        "thirdparty\\glslang\\glslang\\Public",
        "thirdparty\\glslang\\SPIRV",
        "thirdparty\\graphite\\include\\graphite2",
        "thirdparty\\graphite\\src\\inc",
        "thirdparty\\harfbuzz\\src",
        "thirdparty\\icu4c",
        "thirdparty\\icu4c\\common",
        "thirdparty\\icu4c\\common\\unicode",
        "thirdparty\\icu4c\\i18n",
        "thirdparty\\icu4c\\i18n\\unicode",
        "thirdparty\\jolt_physics\\Jolt",
        "thirdparty\\jolt_physics\\Jolt\\AABBTree",
        "thirdparty\\jolt_physics\\Jolt\\AABBTree\\NodeCodec",
        "thirdparty\\jolt_physics\\Jolt\\AABBTree\\TriangleCodec",
        "thirdparty\\jolt_physics\\Jolt\\Core",
        "thirdparty\\jolt_physics\\Jolt\\Geometry",
        "thirdparty\\jolt_physics\\Jolt\\Math",
        "thirdparty\\jolt_physics\\Jolt\\ObjectStream",
        "thirdparty\\jolt_physics\\Jolt\\Physics",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Body",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Character",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Collision",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Collision\\BroadPhase",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Collision\\Shape",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Constraints",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Constraints\\ConstraintPart",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Ragdoll",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\SoftBody",
        "thirdparty\\jolt_physics\\Jolt\\Physics\\Vehicle",
        "thirdparty\\jolt_physics\\Jolt\\Renderer",
        "thirdparty\\jolt_physics\\Jolt\\Skeleton",
        "thirdparty\\jolt_physics\\Jolt\\TriangleSplitter",
        "thirdparty\\libbacktrace",
        "thirdparty\\libjpeg-turbo\\src",
        "thirdparty\\libktx\\include",
        "thirdparty\\libktx\\include\\KHR",
        "thirdparty\\libktx\\lib",
        "thirdparty\\libktx\\lib\\dfdutils",
        "thirdparty\\libktx\\lib\\dfdutils\\KHR",
        "thirdparty\\libktx\\other_include\\KHR",
        "thirdparty\\libktx\\utils",
        "thirdparty\\libogg",
        "thirdparty\\libogg\\ogg",
        "thirdparty\\libpng",
        "thirdparty\\libtheora",
        "thirdparty\\libtheora\\theora",
        "thirdparty\\libtheora\\x86",
        "thirdparty\\libtheora\\x86_vc",
        "thirdparty\\libvorbis",
        "thirdparty\\libvorbis\\books\\coupled",
        "thirdparty\\libvorbis\\books\\floor",
        "thirdparty\\libvorbis\\books\\uncoupled",
        "thirdparty\\libvorbis\\modes",
        "thirdparty\\libvorbis\\vorbis",
        "thirdparty\\libwebp\\sharpyuv",
        "thirdparty\\libwebp\\src\\dec",
        "thirdparty\\libwebp\\src\\dsp",
        "thirdparty\\libwebp\\src\\enc",
        "thirdparty\\libwebp\\src\\mux",
        "thirdparty\\libwebp\\src\\utils",
        "thirdparty\\libwebp\\src\\webp",
        "thirdparty\\linuxbsd_headers\\alsa",
        "thirdparty\\linuxbsd_headers\\alsa\\sound",
        "thirdparty\\linuxbsd_headers\\dbus",
        "thirdparty\\linuxbsd_headers\\fontconfig",
        "thirdparty\\linuxbsd_headers\\libdecor-0",
        "thirdparty\\linuxbsd_headers\\pulse",
        "thirdparty\\linuxbsd_headers\\speechd",
        "thirdparty\\linuxbsd_headers\\udev",
        "thirdparty\\linuxbsd_headers\\wayland",
        "thirdparty\\linuxbsd_headers\\X11",
        "thirdparty\\linuxbsd_headers\\X11\\extensions",
        "thirdparty\\linuxbsd_headers\\X11\\Xcursor",
        "thirdparty\\linuxbsd_headers\\xkbcommon",
        "thirdparty\\manifold\\include\\manifold",
        "thirdparty\\manifold\\src",
        "thirdparty\\mbedtls\\include",
        "thirdparty\\mbedtls\\include\\mbedtls",
        "thirdparty\\mbedtls\\include\\psa",
        "thirdparty\\mbedtls\\library",
        "thirdparty\\meshoptimizer",
        "thirdparty\\mingw-std-threads",
        "thirdparty\\minimp3",
        "thirdparty\\miniupnpc\\include\\miniupnpc",
        "thirdparty\\miniupnpc\\src",
        "thirdparty\\minizip",
        "thirdparty\\misc",
        "thirdparty\\msdfgen",
        "thirdparty\\msdfgen\\core",
        "thirdparty\\openxr\\include\\openxr",
        "thirdparty\\openxr\\src",
        "thirdparty\\openxr\\src\\common",
        "thirdparty\\openxr\\src\\external\\jsoncpp\\include\\json",
        "thirdparty\\openxr\\src\\external\\jsoncpp\\src\\lib_json",
        "thirdparty\\openxr\\src\\loader",
        "thirdparty\\pcre2\\deps\\sljit\\sljit_src",
        "thirdparty\\pcre2\\src",
        "thirdparty\\recastnavigation\\Recast\\Include",
        "thirdparty\\rvo2\\rvo2_2d",
        "thirdparty\\rvo2\\rvo2_3d",
        "thirdparty\\spirv-cross",
        "thirdparty\\spirv-cross\\include\\spirv_cross",
        "thirdparty\\spirv-reflect",
        "thirdparty\\spirv-reflect\\include\\spirv\\unified1",
        "thirdparty\\swappy-frame-pacing",
        "thirdparty\\swappy-frame-pacing\\common",
        "thirdparty\\thorvg\\inc",
        "thirdparty\\thorvg\\src\\common",
        "thirdparty\\thorvg\\src\\loaders\\external_jpg",
        "thirdparty\\thorvg\\src\\loaders\\external_png",
        "thirdparty\\thorvg\\src\\loaders\\external_webp",
        "thirdparty\\thorvg\\src\\loaders\\raw",
        "thirdparty\\thorvg\\src\\loaders\\svg",
        "thirdparty\\thorvg\\src\\renderer",
        "thirdparty\\thorvg\\src\\renderer\\sw_engine",
        "thirdparty\\tinyexr",
        "thirdparty\\ufbx",
        "thirdparty\\vhacd\\inc",
        "thirdparty\\vhacd\\public",
        "thirdparty\\volk",
        "thirdparty\\vulkan",
        "thirdparty\\vulkan\\include\\vk_video",
        "thirdparty\\vulkan\\include\\vulkan",
        "thirdparty\\wslay",
